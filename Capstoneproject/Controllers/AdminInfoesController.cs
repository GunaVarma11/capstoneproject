...
namespace Capstoneproject.Controllers
{
    public class AdminInfoesController : Controller
    {
        ...
        public AdminInfoesController(InfoDbContext context)
        {
            _context = context;
        }
        //adminlogin
        ...
        public async Task<IActionResult> Index()
        {
              return _context.AdminInfo != null ? 
                          ...
                          Problem("Entity set 'InfoDbContext.AdminInfo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'InfoDbContext.AdminInfo'  is null.");
            }
            var adminInfo = await _context.AdminInfo.FindAsync(id);
            if (adminInfo != null)
            {
