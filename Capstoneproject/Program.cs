...
builder.Services.AddDbContext<InfoDbContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("InfoDbContext") ?? throw new InvalidOperationException("Connection string 'BlogTrackerdbContext' not found.")));
